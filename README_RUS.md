...
| 14 | char *strerror(int errnum) | Выполняет поиск во внутреннем массиве номера ошибки errnum и возвращает указатель на строку с сообщением об ошибке. |
...
- format −  это С-строка, содержащая один или несколько следующих элементов: пробельный символ, непробельный символ и спецификаторы формата. Спецификатор формата следует прототипу: %[флаги][ширина][.точность][длина]спецификатор.
...
| --- | --- | --- |
| 1 | c | Символ |
| 2 | d or i | Знаковое десятичное целое число |
| 3 | e | Научная нотация (мантисса/экспонента) с использованием символа e |
| 4 | E | Научная нотация (мантисса/экспонента) с использованием символа Е |
| 5 | f | Десятичное число с плавающей точкой |
| 6 | g | Использует кратчайший из представлений форматов %e или %f |
| 7 | G | Использует кратчайший из представлений форматов %E или %F |
| 8 | o | Знаковое восьмеричное число |
| 9 | s | Строка символов |
| 10 | u | Безнаковое десятичное целое число |
| 11 | x | Безнаковое шестнадцатеричное целое число |
| 12 | X | Безнаковое шестнадцатеричное целое число (заглавные буквы) |
| 13 | p | Адрес указателя |
| 14 | n | Ничего не печатает |
| 15 | % | Символ % |

### sprintf and sscanf Флаги
...
## Part 1. Реализация функции библиотеки string.h
...
- Библиотека должна быть разработана в соответствии с принципами структурного программирования, должно быть искючено дублирование в коде
- Подготовить полное покрытие unit-тестами функций библиотеки c помощью библиотеки Check
- Предусмотреть Makefile для сборки библиотеки и тестов (с целями all, clean, test, s21_string.a)
- Перед каждой функцией использовать префикс s21_
- Запрещено копирование реализации стандартной библиотеки string.h и других библиотек по обработке строк
...
## Part 2. Реализация функций sprintf и sscanf
